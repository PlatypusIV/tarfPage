        ...
        return (<div>
            <footer id="footer">
                <div class="inner">
                    ...
                    <p class="copyright">&copy; Untitled. Design: <a href="https://templated.co">TEMPLATED</a>. Reactified by: : <a href="https://github.com/PlatypusIV"><strong>Herbert-Ken Ümera</strong></a></p>
                </div>
            </footer>
        </div>)
    }
